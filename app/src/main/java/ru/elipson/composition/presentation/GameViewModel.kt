...
class GameViewModel(
    ...
    private fun updateProgress() {
        ...
        _progressAnswers.value = String.format(
            ...
            countOfRightAnswers,
            gameSettings.minCountOfWriteAnswers
        )
        _enoughCount.value = countOfRightAnswers >= gameSettings.minCountOfWriteAnswers
        _enoughPercent.value = percent >= gameSettings.minCountOfWriteAnswers
    }
    ...
    private fun getGameSettings() {
        ...
        _minPercent.value = gameSettings.minPercentOfWriteAnswers
    }
